...
tree = ET.parse(raw_input('Input file (include suffix):'))
root = tree.getroot()

xml = xml.dom.minidom.parse(raw_input('PrettyXML input file (include suffix):'))
...
tree.write(raw_input('Output file (include suffix):'))
